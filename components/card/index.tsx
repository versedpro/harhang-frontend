...
const Card = ({ title, region, price, image, currency, like }: { title: string, region: string, price: number, image: string, currency: string, like: boolean }) => {
  return (
    <div className={classNames([styles.wrapper, styles.wrapperAnime])}>
      <div className={styles.header}>
        ...
        <div className={styles.badgeWrapper}>
          ...
          >
            {like ? (
              <img src="/image/liked.svg" />
            ) :(
              <img src="/image/unliked.svg" />
            )}
          </div>
          <div
